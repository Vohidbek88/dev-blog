...
const Signin = () => {
    ...
    const { userdata ,handleSignin,isPending,theme} = useContext(DataContext)
    ...
    return (
        <div className={`flex h-[92vh] flex-col justify-center px-6 py-12 lg:px-8 bg-${theme}`}>
            <Helmet>
                <title>Sign in</title>
            </Helmet>
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 className={`mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-${theme=='white' ? 'gray-900':'white'}`}>Sign in to your account</h2>
                {
